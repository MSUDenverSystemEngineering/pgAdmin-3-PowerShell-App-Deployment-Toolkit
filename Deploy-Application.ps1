...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'pgAdmin III'
	[string]$appVersion = 'v1.22.2'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '01/30/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close pgAdmin III, verify there is enough disk space to complete the install, and persist the prompt
		Show-InstallationWelcome -CloseApps 'pgadmin3' -CheckDiskSpace -PersistPrompt
		...
		Execute-MSI -Action "Install" -Path "pgadmin3.msi" -Parameters "REBOOT=ReallySuppress /QN" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'pgadmin3' -CloseAppsCountdown 60
		...
		Execute-MSI -Action "Uninstall" -Path "pgadmin3.msi" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxbSRVBNyGP+cM
# mY9CiWSCvhSuXTMQZ770gWAluKptuqCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIAiS
# 232AXsIsQxR9qvSfDCxCicjuBYzl6a5WfV/h81V6MA0GCSqGSIb3DQEBAQUABIIB
# AIih3EZjNWQEezslEmP/rNvMQh91mSHRPUDs66tKF7+YB2KS9Ay69gdtrByGzJgU
# nhP9wUdT+UdNCLJ70Q1fu7CXw6GJAPkTgpxUADgT0/B6IRXaxM9JDL6/FJ7wUZT8
# qaZzHHjoOJ27dCDh5P50IJXQlS9nIamGciLERENfvyNSFFQ7xXtaDDCWC6YxGNuV
# IypMzVwYX9F63AYuhRmAXxy57r2nr+qisO5itKZ0kp9F813u+8fVsVa6IKc8dGC4
# WcXe83uVz0aKh49lXD1+GYHnsCqiokdQHaImOydsLj8PP3fU3ujQ0mK8Fl2j6j+4
# BtipvZCVzCFZDjLEn5gJDb+hggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMTMwMjExOTIzWjAjBgkqhkiG9w0BCQQxFgQU
# 92Oscr/pXUawqAwut7NuounS2AAwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAGre7yc+6Ld2oTkfNBY7AS4opdF6X5yxu1U20lpLPz/wbGZXHDT940s5
# wAu4BQUtd2iIhtr9lFSVPOmLePL3HxROCn7uLjFbqXDWYTrsb9/t1iOAzcMd3V83
# ei/O0+JPGBYFY9sXAc7ySDPF5YByA65F62eWEy9UB1Ich/LYTaHR+OpKrvQdrYoj
# VSMSLbuVtiCsJ4jcTVMr5N5RwUXL0jarlgtifCkzLafGsFneCiOp6+BkkaIBztOq
# gQWhwDW6xhLBuGGOt6SuP3v3zEvfjADWQ9nJykCZQ5mEf1jl0rTEXXgSJbr8woNr
# 7qI7MwDBnQhSFZmnd2sd9MtlA5AE6uI=
